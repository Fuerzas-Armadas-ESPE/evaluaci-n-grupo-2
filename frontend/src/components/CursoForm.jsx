...
export default function CursoForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const url = params.id ? `http://localhost:3000/cursos/${params.id}` : 'http://localhost:3000/cursos';
    ...
    return (
        <Grid container direction='column' alignItems="center" justifyContent="center">
            <Grid item xs={3}>
                ...
                >
                    <Typography variant='5' textAlign='center' color='white'>{params.id ? 'Editar Curso' : 'Crear Curso'}</Typography>
                    <CardContent>
